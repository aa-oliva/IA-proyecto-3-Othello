...
//cuando tengo undefined que haga un random
var tournamentID=12;
var user_name='AndresO2';
var movimiento=0; 
var myID;
var playerTurnID;
var otherID;
//192.168.0.107
var socket = require('socket.io-client')('http://192.168.1.146:4000');
var tablero;
var last=1000; 
var resul_mov=[];
var pesos=[
		...
		for(var j=0;j<tablero.length;j++){
			...
			if(myF){
				if(tablero[j][i]==inverse(id)){
					otF=1;
					fichasV.push((j*8)+i);
					//console.log("ficha contraria horizontal 1");
				}else{
					myF=0; 
				}
			}
			if(tablero[j][i]==id){
				//console.log('ficha mia encontrada horizontal 1');
				fichasV=[];
				myF=1; 
			} 
		 	if(otF){
			...
			if(myF1){
				if(tablero[i][j]==inverse(id)){
					otF1=1; 
					fichasV1.push((i*8)+j);
					//console.log("ficha contraria vertical 1");
				}else{
					myF1=0; 
				}
			}
			if(tablero[i][j]==id){
				//console.log('ficha mia encontrada vertical 1');
				fichasV1=[];
				myF1=1; 
			} 
		 	if(otF1){
		...
		for(var j=tablero.length-1;j>=0;j--){
			...
			if(myF){
				if(tablero[j][i]==inverse(id)){
					otF=1; 
					fichasV.push((j*8)+i);
					//console.log("ficha contraria horizontal 2");
				}else{
					myF=0; 
				}
			}
			if(tablero[j][i]==id){
				//console.log('ficha mia encontrada horizontal 2');
				myF=1; 
				fichasV=[];
			} 
		 	if(otF){
			...
			if(myF1){
				if(tablero[i][j]==inverse(id)){
					otF1=1; 
					fichasV1.push((i*8)+j);
					//console.log("ficha contraria vertical 2");
				}else{
					myF1=0; 
				}
			}
			if(tablero[i][j]==id){
				//console.log('ficha mia encontrada vertical 2');
				myF1=1; 
				fichasV1=[];
			} 
		 	if(otF1){
			...
			if(j+i<8){
				if(myF){
					if(tablero[j][j+i]==inverse(id)){
						...
						//console.log("ficha contraria diagonal 1");
					}else{
						myF=0; 
					}
				}
				if(tablero[j][j+i]==id){
					//console.log('ficha mia encontrada diagonal 1');
					myF=1; 
					fichasV=[];
				} 
			 	if(otF){
				...
				if(myF1){
					if(tablero[j+i][j]==inverse(id)){
						...
						//console.log("ficha contraria diagonal 1-2");
					}else{
						myF1=0; 
					}
				}
				if(tablero[j+i][j]==id){
					//console.log('ficha mia encontrada diagonal 1-2');
					myF1=1; 
					fichasV1=[];
				} 
			 	if(otF1){
					if(tablero[j+i][j]==0){
						otF1=0; 
						//console.log('exito diagonal 1-2')
			...
			if(cost<8){
				...
				if(myF){
					if(tablero[j][cost]==inverse(id)){
						...
						//console.log("ficha contraria diagonal 2");
					}else{
						myF=0; 
					}
				}
				if(tablero[j][cost]==id){
					//console.log('ficha mia encontrada diagonal 2');
					myF=1; 
					fichasV=[];
				} 
			 	if(otF){
				...
				if(tablero[7-cost][7-j]==id){
					//console.log('ficha mia encontrada diagonal 2-2');
					myF1=1; 
					fichasV1=[];
				} 
			 	if(otF1){
					if(tablero[7-cost][7-j]==0){
						otF1=0; 
						//console.log('exito diagonal 2-2')
			...
			if(i-j>=0){
				if(myF){
					if(tablero[j][i-j]==inverse(id)){
						...
						//console.log("ficha contraria diagonal 3");
					}else{
						myF=0; 
					}
				}
				if(tablero[j][i-j]==id){
					//console.log('ficha mia encontrada diagonal 3');
					myF=1;
					fichasV=[]; 
				} 
			 	if(otF){
				...
				if(myF1){
					if(tablero[7-(i-j)][7-j]==inverse(id)){
						...
						//console.log("ficha contraria diagonal 3-2");
					}else{
						myF1=0; 
					}
				}
				if(tablero[7-(i-j)][7-j]==id){
					//console.log('ficha mia encontrada1 diagonal 3-2');
					myF1=1; 
					fichasV1=[];
				} 
			 	if(otF1){
					if(tablero[7-(i-j)][7-j]==0){
						otF1=0; 
						//console.log('exito diagonal 3-2');
			...
			if(j-i>=0){
				...
				if(myF){
					if(tablero[j][j-i]==inverse(id)){
						otF=1; 
						fichasV.push((j*8)+j+i);
						//console.log("ficha contraria diagonal 4");
					}else{
						myF=0; 
					}
				}
				if(tablero[j][j-i]==id){
					//console.log('ficha mia encontrada diagonal 4');
					myF=1; 
					fichasV=[];
				} 
			 	if(otF){
				...
				if(myF1){
					if(tablero[j-i][j]==inverse(id)){
						otF1=1;
						fichasV1.push(((j-i)*8)+j);
						//console.log("ficha contraria diagonal 4-2");
					}else{
						myF1=0; 
					}
				}
				if(tablero[j-i][j]==id){
					//console.log('ficha mia encontrada diagonal 4-2');
					myF1=1;
					fichasV1=[];
				} 
			 	if(otF1){
					if(tablero[j-i][j]==0){
						otF1=0; 
						//console.log('exito diagonal 4-2')
						if(fichasV1.length>0 && movs.indexOf(((j-i)*8)+j)==-1){
							movs.push(((j-i)*8)+j);
							resul_mov.push([((j-i)*8)+j,fichasV1]);
						}
